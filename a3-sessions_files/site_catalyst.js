...
var s_account="anactivecombeta,anactivecomprod"
var s_tan=s_gi(s_account)

/************************** CONFIG SECTION **************************/

/* Conversion Config */
s_tan.currencyCode="USD"

/* Link Tracking Config */
s_tan.trackDownloadLinks=true
s_tan.trackExternalLinks=true
s_tan.trackInlineStats=true
s_tan.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
s_tan.linkInternalFilters=="javascript:,active.com,activenetwork.com,bookings.diy.com,register.paragonmeetings.com,register.techneat.com,regonline.activeeurope.com,regonline.activeglobal.com,123enroll.com,ersvponline.com,regonline.ca,regonline.co.nz,regonline.co.uk,regonline.com,regonline.com.au,regonline.com.es,regonline.de.com,regonline.fr,regonline.hk,regonline.hk.cn,regonline.ie,regonline.sg"
s_tan.linkLeaveQueryString=true
s_tan.linkTrackVars="prop26,prop27,prop28,prop29"
s_tan.linkTrackEvents="None"

/* Plugin Config */
s_tan.usePlugins=true
...
function s_tan_doPlugins(s_tan) {
  ...
  if(!s_tan.campaign)
    s_tan.campaign=s_tan.getQueryParam('cmp')
    s_tan.campaign=s_tan.getValOnce(s_tan.campaign,'s_tan_campaign',0)

  /* Internal Campaign Tracking */
  var internalCampaign = s_tan.getQueryParam('int');
  s_tan.eVar41 = s_tan.getValOnce(internalCampaign, 's_tan_internal_campaign',0);
  
  /* Site Search */
  if(s_tan.prop11){
    s_tan.prop11=s_tan.prop11.toLowerCase();
    s_tan.prop12=s_tan.prop12.toLowerCase();
    s_tan.prop13=s_tan.prop13.toLowerCase();
    s_tan.prop14=s_tan.prop14.toLowerCase();
    s_tan.prop15=s_tan.prop15.toLowerCase();
    s_tan.eVar11="D=c11"
    s_tan.eVar12="D=c12"
    s_tan.eVar13="D=c13"
    s_tan.eVar14="D=c14"
    ...
    var t_search=s_tan.getValOnce(s_tan.eVar11,'ev11',0);
    if(t_search){
        s_tan.events=s_tan.apl(s_tan.events,"event1",",",2);
        }
}

/* Set Page View Event */
s_tan.events=s_tan.apl(s_tan.events,'event2',',',2)

/* Set Time Parting Variables - SAMPLE EST */
if(!s_tan.prop16&&!s_tan.eVar16) s_tan.prop16=s_tan.eVar16=s_tan.getTimeParting('h','-8'); // Set hour 
if(!s_tan.prop17&&!s_tan.eVar17) s_tan.prop17=s_tan.eVar17=s_tan.getTimeParting('d','-8'); // Set day 
if(!s_tan.prop18&&!s_tan.eVar18) s_tan.prop18=s_tan.eVar18=s_tan.getTimeParting('w','-8'); // Set weekday 

/* Link Tracking */
  s_tan.hbx_lt = "auto" // manual, auto
  s_tan.setupLinkTrack("prop26,prop27,prop28,prop29","SC_LINKS");

  /* Enhanced download tracking */
  s_tan.url=s_tan.downloadLinkHandler();
  if(s_tan.url){
     //Track FileName
                  s_tan.eVar27=s_tan.url.substring(s_tan.url.lastIndexOf("/")+1,s_tan.url.length);
      s_tan.prop9="D=v27";
      s_tan.prop8="D=pageName";
                  s_tan.events=s_tan.apl(s_tan.events,"event13",",",2);                                          
                 //Track eVar & Event
                        s_tan.linkTrackVars=s_tan.linkTrackVars+",prop8,prop9,eVar27,events";
                        s_tan.linkTrackEvents="event13";
  }

//collapse subdomains into domains 
var _sc_host = location.host;
var _sc_referrer = document.referrer;
var _sc_directLoad = true;

if(_sc_referrer != '') {
  _sc_referrer = _sc_referrer.substr(_sc_referrer.indexOf('://') + 3);
  _sc_referrer = _sc_referrer.substr(0, _sc_referrer.indexOf('/'));
  var _sc_referrerParts = _sc_referrer.split('.');
  var _sc_hostParts = _sc_host.split('.');
  
  if( _sc_referrerParts[_sc_referrerParts.length - 2] != _sc_hostParts[_sc_hostParts.length - 2] ||
    _sc_referrerParts[_sc_referrerParts.length - 1] != _sc_hostParts[_sc_hostParts.length - 1])
    _sc_directLoad = false;
} 
if(_sc_directLoad) {
  s_tan.prop24 = 'Direct Load';
} else {
  s_tan.prop24 = _sc_referrer;
}
    
/* Copy props to eVars */
if(s_tan.pageName&&!s_tan.eVar9) s_tan.eVar9="D=pageName";
if(s_tan.channel&&!s_tan.eVar1) s_tan.eVar1="D=ch";
if(s_tan.prop1&&!s_tan.eVar2) s_tan.eVar2="D=c1";
if(s_tan.prop2&&!s_tan.eVar3) s_tan.eVar3="D=c2";
if(s_tan.prop3&&!s_tan.eVar4) s_tan.eVar4="D=c3";
if(s_tan.prop4&&!s_tan.eVar5) s_tan.eVar5="D=c4";
if(s_tan.prop5&&!s_tan.eVar6) s_tan.eVar6="D=c5";
if(s_tan.prop6&&!s_tan.eVar7) s_tan.eVar7="D=c6";
if(s_tan.prop7&&!s_tan.eVar8) s_tan.eVar8="D=c7";
if(s_tan.prop10&&!s_tan.eVar10) s_tan.eVar10="D=c10";
if(s_tan.prop16&&!s_tan.eVar16) s_tan.eVar16="D=c16";
if(s_tan.prop17&&!s_tan.eVar17) s_tan.eVar17="D=c17";
if(s_tan.prop18&&!s_tan.eVar18) s_tan.eVar18="D=c18";
if(s_tan.prop19&&!s_tan.eVar19) s_tan.eVar19="D=c19";
if(s_tan.prop21&&!s_tan.eVar21) s_tan.eVar21="D=c21";
if(s_tan.prop22&&!s_tan.eVar22) s_tan.eVar22="D=c22"; 
if(s_tan.prop23&&!s_tan.eVar23) s_tan.eVar23="D=c23";
if(s_tan.prop24&&!s_tan.eVar24) s_tan.eVar24="D=c24";
if(s_tan.prop25&&!s_tan.eVar25) s_tan.eVar25="D=c25";
if(s_tan.prop30&&!s_tan.eVar30) s_tan.eVar30="D=c30";
if(s_tan.prop31&&!s_tan.eVar31) s_tan.eVar31="D=c31";
if(s_tan.prop32&&!s_tan.eVar32) s_tan.eVar32="D=c32";
if(s_tan.prop33&&!s_tan.eVar33) s_tan.eVar33="D=c33";
if(s_tan.prop34&&!s_tan.eVar34) s_tan.eVar34="D=c34";
if(s_tan.prop35&&!s_tan.eVar35) s_tan.eVar35="D=c35";
if(s_tan.prop36&&!s_tan.eVar36) s_tan.eVar36="D=c36";
if(s_tan.prop37&&!s_tan.eVar37) s_tan.eVar37="D=c37";
if(s_tan.prop38&&!s_tan.eVar38) s_tan.eVar38="D=c38";
if(s_tan.prop39&&!s_tan.eVar39) s_tan.eVar39="D=c39";
if(s_tan.prop40&&!s_tan.eVar40) s_tan.eVar40="D=c40";

  /* loads SC variables into TnT */ 
  if(typeof(mboxLoadSCPlugin) == 'function') {
    mboxLoadSCPlugin(s_tan)
  }

  /* Plugin Example: trackTNT 1.0 */
  s_tan.tnt = s_tan.trackTNT();

}
s_tan.doPlugins=s_tan_doPlugins
/************************** PLUGINS SECTION *************************/
 ...
 */
s_tan.getVisitNum=new Function(""
 ...
 */
s_tan.getNewRepeat=new Function(""
 ...
 */
s_tan.getAndPersistValue=new Function("v","c","e",""
 ...
 */
s_tan.downloadLinkHandler=new Function("p",""
 ...
 */
s_tan.setupLinkTrack=new Function("vl","c",""
...
s_tan._IL=new Function("a","var s=this;return a!='undefined'?a.length:0");
s_tan._II=new Function("a","b","c","var s=this;return a.indexOf(b,c?c:0)"
);
s_tan._IS=new Function("a","b","c",""
+"var s=this;return b>s._IL(a)?'':a.substring(b,c!=null?c:s._IL(a))");
s_tan._LN=new Function("a","b","c","d",""
+"var s=this;b=a.href;b+=a.name?a.name:'';c=s._LVP(b,'lid');d=s._LVP("
+"b,'lpos');r"
+"eturn[c,d]");
s_tan._LVP=new Function("a","b","c","d","e",""
+"var s=this;c=s._II(a,'&'+b+'=');c=c<0?s._II(a,'?'+b+'='):c;if(c>-1)"
+"{d=s._II(a,'&',c+s._IL(b)+2);e=s._IS(a,c+s._IL(b)+2,d>-1?d:s._IL(a)"
+");return e}return ''");
s_tan._LS=new Function("a",""
+"var s=this,b,c=100,d,e,f,g;b=(s._IL(a)>c)?escape(s._IS(a,0,c)):esca"
+"pe(a);b=s._LSP(b,'%0A','%20');b=s._LSP(b,'%0D','%20');b=s._LSP(b,'%"
+"09','%20');c=s._IP(b,'%20');d=s._NA();e=0;for(f=0;f<s._IL(c);f++){g"
+"=s._RP(c[f],'%20','');if(s._IL(g)>0){d[e++]=g}}b=d.join('%20');retu"
+"rn unescape(b)");
s_tan._LSP=new Function("a","b","c","d","var s=this;d=s._IP(a,b);return d"
+".join(c)");
s_tan._IP=new Function("a","b","var s=this;return a.split(b)");
s_tan._RP=new Function("a","b","c","d",""
+"var s=this;d=s._II(a,b);if(d>-1){a=s._RP(s._IS(a,0,d)+','+s._IS(a,d"
+"+s._IL(b),s._IL(a)),b,c)}return a");
s_tan._TL=new Function("a","var s=this;return a.toLowerCase()");
s_tan._NA=new Function("a","var s=this;return new Array(a?a:0)");
s_tan._hbxm=new Function("m","var s=this;return (''+m).indexOf('{')<0");
s_tan._hbxln=new Function("h","var s=this,n=s.linkNames;if(n)return s.pt("
+"n,',','lnf',h);return ''");
 ...
 */
s_tan.getQueryParam=new Function("p","d","u",""
+"var s=this,v='',i,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.locati"
+"on);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p"
+".length:i;t=s.p_gpv(p.substring(0,i),u+'');if(t){t=t.indexOf('#')>-"
+"1?t.substring(0,t.indexOf('#')):t;}if(t)v+=v?d+t:t;p=p.substring(i="
+"=p.length?i:i+1)}return v");
s_tan.p_gpv=new Function("k","u",""
+"var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=s.pt(q,'&','p_gvf',k)}return v");
s_tan.p_gvf=new Function("t","k",""
 ...
 */
s_tan.getValOnce=new Function("v","c","e",""
 ...
 */
s_tan.getTimeParting=new Function("t","z",""
 ...
 */
s_tan.apl=new Function("l","v","d","u",""
 ...
 */
if(!s_tan.__ccucr){s_tan.c_rr=s_tan.c_r;s_tan.__ccucr = true;
s_tan.c_r=new Function("k",""
 ...
 */
if(!s_tan.__ccucw){s_tan.c_wr=s_tan.c_w;s_tan.__ccucw = true;
s_tan.c_w=new Function("k","v","e",""
+"this.new2 = true;"
...
*/
s_tan.trackTNT =new Function("v","p","b",""
...
s_tan.Media.autoTrack=false
s_tan.Media.trackWhilePlaying=true
s_tan.Media.trackVars="None"
s_tan.Media.trackEvents="None"

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
s_tan.visitorNamespace="activenetwork"
s_tan.trackingServer="metrics.active.com"
s_tan.trackingServerSecure="smetrics.active.com"
s_tan.dc="122"
s_tan.visitorMigrationKey="4C1A8A8C"

/****************************** MODULES *****************************/
/* Module: Media */
s_tan.m_Media_c="var m=s.m_i('Media');m.cn=function(n){var m=this;return m.s.rep(m.s.rep(m.s.rep(n,\"\\n\",''),\"\\r\",''),'--**--','')};m.open=function(n,l,p,b){var m=this,i=new Object,tm=new Date,a"
+"='',x;n=m.cn(n);l=parseInt(l);if(!l)l=1;if(n&&p){if(!m.l)m.l=new Object;if(m.l[n])m.close(n);if(b&&b.id)a=b.id;for (x in m.l)if(m.l[x]&&m.l[x].a==a)m.close(m.l[x].n);i.n=n;i.l=l;i.p=m.cn(p);i.a=a;i"
+".t=0;i.ts=0;i.s=Math.floor(tm.getTime()/1000);i.lx=0;i.lt=i.s;i.lo=0;i.e='';i.to=-1;m.l[n]=i}};m.close=function(n){this.e(n,0,-1)};m.play=function(n,o){var m=this,i;i=m.e(n,1,o);i.m=new Function('v"
+"ar m=s_c_il['+m._in+'],i;if(m.l){i=m.l[\"'+m.s.rep(i.n,'\"','\\\\\"')+'\"];if(i){if(i.lx==1)m.e(i.n,3,-1);i.mt=setTimeout(i.m,5000)}}');i.m()};m.stop=function(n,o){this.e(n,2,o)};m.track=function(n"
+"){var m=this;if (m.trackWhilePlaying) {m.e(n,4,-1)}};m.e=function(n,x,o){var m=this,i,tm=new Date,ts=Math.floor(tm.getTime()/1000),ti=m.trackSeconds,tp=m.trackMilestones,z=new Array,j,d='--**--',t="
+"1,b,v=m.trackVars,e=m.trackEvents,pe='media',pev3,w=new Object,vo=new Object;n=m.cn(n);i=n&&m.l&&m.l[n]?m.l[n]:0;if(i){w.name=n;w.length=i.l;w.playerName=i.p;if(i.to<0)w.event=\"OPEN\";else w.event"
+"=(x==1?\"PLAY\":(x==2?\"STOP\":(x==3?\"MONITOR\":\"CLOSE\")));w.openTime=new Date();w.openTime.setTime(i.s*1000);if(x>2||(x!=i.lx&&(x!=2||i.lx==1))) {b=\"Media.\"+name;pev3 = m.s.ape(i.n)+d+i.l+d+m"
+".s.ape(i.p)+d;if(x){if(o<0&&i.lt>0){o=(ts-i.lt)+i.lo;o=o<i.l?o:i.l-1}o=Math.floor(o);if(x>=2&&i.lo<o){i.t+=o-i.lo;i.ts+=o-i.lo;}if(x<=2){i.e+=(x==1?'S':'E')+o;i.lx=x;}else if(i.lx!=1)m.e(n,1,o);i.l"
+"t=ts;i.lo=o;pev3+=i.t+d+i.s+d+(m.trackWhilePlaying&&i.to>=0?'L'+i.to:'')+i.e+(x!=2?(m.trackWhilePlaying?'L':'E')+o:'');if(m.trackWhilePlaying){b=0;pe='m_o';if(x!=4){w.offset=o;w.percent=((w.offset+"
+"1)/w.length)*100;w.percent=w.percent>100?100:Math.floor(w.percent);w.timePlayed=i.t;if(m.monitor)m.monitor(m.s,w)}if(i.to<0)pe='m_s';else if(x==4)pe='m_i';else{t=0;v=e='None';ti=ti?parseInt(ti):0;z"
+"=tp?m.s.sp(tp,','):0;if(ti&&i.ts>=ti)t=1;else if(z){if(o<i.to)i.to=o;else{for(j=0;j<z.length;j++){ti=z[j]?parseInt(z[j]):0;if(ti&&((i.to+1)/i.l<ti/100)&&((o+1)/i.l>=ti/100)){t=1;j=z.length}}}}}}}el"
+"se{m.e(n,2,-1);if(m.trackWhilePlaying){w.offset=i.lo;w.percent=((w.offset+1)/w.length)*100;w.percent=w.percent>100?100:Math.floor(w.percent);w.timePlayed=i.t;if(m.monitor)m.monitor(m.s,w)}m.l[n]=0;"
...
+"vo.pe=pe;vo.pev3=pev3;m.s.t(vo,b);if(m.trackWhilePlaying){i.ts=0;i.to=o;i.e=''}}}}return i};m.ae=function(n,l,p,x,o,b){if(n&&p){var m=this;if(!m.l||!m.l[n])m.open(n,l,p,b);m.e(n,x,o)}};m.a=function"
+"(o,t){var m=this,i=o.id?o.id:o.name,n=o.name,p=0,v,c,c1,c2,xc=m.s.h,x,e,f1,f2='s_media_'+m._in+'_oc',f3='s_media_'+m._in+'_t',f4='s_media_'+m._in+'_s',f5='s_media_'+m._in+'_l',f6='s_media_'+m._in+'"
+"_m',f7='s_media_'+m._in+'_c',tcf,w;if(!i){if(!m.c)m.c=0;i='s_media_'+m._in+'_'+m.c;m.c++}if(!o.id)o.id=i;if(!o.name)o.name=n=i;if(!m.ol)m.ol=new Object;if(m.ol[i])return;m.ol[i]=o;if(!xc)xc=m.s.b;t"
+"cf=new Function('o','var e,p=0;try{if(o.versionInfo&&o.currentMedia&&o.controls)p=1}catch(e){p=0}return p');p=tcf(o);if(!p){tcf=new Function('o','var e,p=0,t;try{t=o.GetQuickTimeVersion();if(t)p=2}"
...
+"=1){p='Windows Media Player '+o.versionInfo;c1=v+',n,p,l,x=-1,cm,c,mn;if(o){cm=o.currentMedia;c=o.controls;if(cm&&c){mn=cm.name?cm.name:c.URL;l=cm.duration;p=c.currentPosition;n=o.playState;if(n){i"
+"f(n==8)x=0;if(n==3)x=1;if(n==1||n==2||n==4||n==5||n==6)x=2;}';c2='if(x>=0)m.ae(mn,l,\"'+p+'\",x,x!=2?p:-1,o)}}';c=c1+c2;if(m.s.isie&&xc){x=m.s.d.createElement('script');x.language='jscript';x.type="
...
+"'QuickTime Player '+(o.GetIsQuickTimeRegistered()?'Pro ':'')+o.GetQuickTimeVersion();f1=f2;c=v+',n,x,t,l,p,p2,mn;if(o){mn=o.GetMovieName()?o.GetMovieName():o.GetURL();n=o.GetRate();t=o.GetTimeScale"
+"();l=o.GetDuration()/t;p=o.GetTime()/t;p2=o.'+f5+';if(n!=o.'+f4+'||p<p2||p-p2>5){x=2;if(n!=0)x=1;else if(p>=l)x=0;if(p<p2||p-p2>5)m.ae(mn,l,\"'+p+'\",2,p2,o);m.ae(mn,l,\"'+p+'\",x,x!=2?p:-1,o)}if(n"
+">0&&o.'+f7+'>=10){m.ae(mn,l,\"'+p+'\",3,p,o);o.'+f7+'=0}o.'+f7+'++;o.'+f4+'=n;o.'+f5+'=p;setTimeout(\"'+v+';o.'+f2+'(0,0)\",500)}';o[f1]=new Function('a','b',c);o[f4]=-1;o[f7]=0;o[f1](0,0)}if(p==3)"
+"{p='RealPlayer '+o.GetVersionInfo();f1=n+'_OnPlayStateChange';c1=v+',n,x=-1,l,p,mn;if(o){mn=o.GetTitle()?o.GetTitle():o.GetSource();n=o.GetPlayState();l=o.GetLength()/1000;p=o.GetPosition()/1000;if"
+"(n!=o.'+f4+'){if(n==3)x=1;if(n==0||n==2||n==4||n==5)x=2;if(n==0&&(p>=l||p==0))x=0;if(x>=0)m.ae(mn,l,\"'+p+'\",x,x!=2?p:-1,o)}if(n==3&&(o.'+f7+'>=10||!o.'+f3+')){m.ae(mn,l,\"'+p+'\",3,p,o);o.'+f7+'="
...
+"+f3+'?500:5000);'+c2);o[f4]=-1;if(m.s.isie)o[f3]=1;o[f7]=0;o[f1](0,0)}};m.as=new Function('e','var m=s_c_il['+m._in+'],l,n;if(m.autoTrack&&m.s.d.getElementsByTagName){l=m.s.d.getElementsByTagName(m"
+".s.isie?\"OBJECT\":\"EMBED\");if(l)for(n=0;n<l.length;n++)m.a(l[n]);}');if(s.wd.attachEvent)s.wd.attachEvent('onload',m.as);else if(s.wd.addEventListener)s.wd.addEventListener('load',m.as,false)";
s_tan.m_i("Media");
